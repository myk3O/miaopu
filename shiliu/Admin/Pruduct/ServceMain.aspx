<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ServceMain.aspx.cs" Inherits="Admin_Servce_ServceMain" %>
                    ...
                    <div id="tab2" class="tabson">
                        <div>
                            ...
                            <ul class="seachform">
                                <li style="width: 20%">
                                    <label>
                                        日韩同步</label><asp:DropDownList runat="server" ID="DropName">
                                ...
                                <li style="width: 20%">
                                    <label>
                                        站长推荐</label><asp:DropDownList runat="server" ID="DropNew">
                                            <asp:ListItem Value="-1">请选择</asp:ListItem>
                                            <asp:ListItem Value="1">是</asp:ListItem>
                                            <asp:ListItem Value="0">否</asp:ListItem>
                                        </asp:DropDownList>
                                    ...
                                    <asp:GridView ID="gridField" runat="server" Width="100%" CssClass="gridview_m" EmptyDataText=""
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="视频系列" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Label ID="lbname1" runat="server" Text='<%#Eval("tClassName") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="日韩同步" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Label ID="lblzhiding" runat="server" Text='<%#Eval("oNewest") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" Font-Size="13px" Width="5%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="站长推荐" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Label ID="lblnew" runat="server" Text='<%#Eval("oTop") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" Font-Size="13px" Width="5%" />
                                            ...
                                            <asp:TemplateField HeaderText="描述" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Label ID="lbtMemo" runat="server" Text='<%#Eval("tMemo") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
                                            ...
                                            <asp:TemplateField HeaderText="产品总售（元）" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Label ID="lballpri" runat="server" Text='<%#Eval("allpri") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
