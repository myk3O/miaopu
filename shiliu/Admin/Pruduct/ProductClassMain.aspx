<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductClassMain.aspx.cs" Inherits="Admin_Pruduct_ProductClassMain" %>
                                    ...
                                    <asp:GridView ID="gridField" runat="server" Width="100%" CssClass="gridview_m" EmptyDataText=""
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="是否上架" HeaderStyle-Font-Bold="false">
                                             ...
                                             <asp:TemplateField HeaderText="是否免费" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Label ID="lboFree" runat="server" Text='<%#Eval("oFree") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" Font-Size="13px" Width="5%" />
