<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherMain.aspx.cs" Inherits="Admin_Teacher_TeacherMain" %>
                    ...
                    <div id="tab2" class="tabson">
                        <div>
                            <ul class="seachform">
                                <li style="width: 20%">
                                    <label>
                                        讲师名称</label><input name="" runat="server" id="keyName" type="text" class="scinput" /></li>
                                ...
                                <td>
                                    <asp:GridView ID="gridField" runat="server" Width="100%" CssClass="gridview_m" EmptyDataText=""
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="讲师名称" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Label ID="lbvName" runat="server" Text='<%#Eval("teacherName") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" Font-Size="13px" Width="8%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="职称" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Label ID="lbprice" runat="server" Text='<%#Eval("teacherdiscrib") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
                                            ...
                                            <asp:TemplateField HeaderText="描述" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Label ID="lbvMemo" runat="server" Text='<%#Eval("teacherMemo") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
                                            ...
                                            <asp:TemplateField HeaderText="头像" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Image ID="img1" ImageUrl='<%#Eval("teacherImg") %>' runat="server" Width="50%" />
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" Font-Size="13px" Width="8%" />
