<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Member_Main.aspx.cs" Inherits="Admin_Members_Member_Main" %>
                                            ...
                                            <asp:TemplateField HeaderText="管    理" HeaderStyle-Font-Bold="false">
                                                <ItemTemplate>
                                                    <div>
                                                        ...
                                                        <asp:Button runat="server" CssClass="btn2 btn-xs btn-default" ID="btnDingdan" CausesValidation="False"
                                                            CommandName="dingdan" CommandArgument='<%# Eval("nID")%>' Text="购买记录" Width="80px" />
