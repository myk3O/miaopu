<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyBranchMain.aspx.cs" Inherits="Admin_Members_MyBranchMain" %>
                                ...
                                <li>
                                    <label>
                                        &nbsp;</label><asp:Button runat="server" ID="ImgSrs" CssClass="btn btn-xs btn-default"
                                            Text="查询" OnClick="ImgSrs_Click" /></li>
                            </ul>
                        </div>--%>
                        <div>
                            <ul class="seachform">
                                <li>
                                    <label>
                                        一班人数：<%=OneLeaveUser %></label>
                                </li>
                                <li>
                                    <label>
                                        二班人数：<%=TwoLeaveUser %></label>
                                </li>
                                <li>
                                    <label>
                                        三班人数：<%=ThreeLeaveUser %></label>
                                </li>

                            </ul>
                        </div>
                        <label>
                            &nbsp;</label><asp:Button runat="server" ID="Button1" CssClass="btn btn-xs btn-default"
                                Text="一班" OnClick="ImgSrs_Click1" /><label>
                                    &nbsp;</label><asp:Button runat="server" ID="Button2" CssClass="btn btn-xs btn-default"
                                        Text="二班" OnClick="ImgSrs_Click2" /><label>
                                            &nbsp;</label><asp:Button runat="server" ID="Button3" CssClass="btn btn-xs btn-default"
                                                Text="三班" OnClick="ImgSrs_Click3" />
