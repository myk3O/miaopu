<%@ Page Language="C#" AutoEventWireup="true" CodeFile="banzhang.aspx.cs" Inherits="Admin_Members_banzhang" %>
        ...
        <div>
            ...
            <div class="formbody">
                <div id="usual1" class="usual">
                            ...
                            <ul class="seachform">
                                <li>
                                    <label style="width: 120px">
                                        分红金额（元）</label><%--onkeyup="value=value.replace(/[^\d]/g,'')"--%>
                                    <asp:TextBox ID="price" runat="server" CssClass="scinputx"></asp:TextBox>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatormulu" runat="server" ErrorMessage="*请输入金额" ForeColor="Red"
                                        ControlToValidate="price" ValidationGroup="btnfh"></asp:RequiredFieldValidator>
                                </li>
                                <li>
                                    <label style="width: 180px">
                                        <%=levelName %>人数：<%=userCount %></label>
                                    <label style="width: 180px">
                                        昨日营业额：<%=yingyee %></label>
                                ...
                                <li>
                                    <label>
                                        &nbsp;</label><asp:Button runat="server" ID="ImgSrs" CssClass="btn btn-xs btn-default"
                                            Text="确认分红" OnClick="ImgSrs_Click" ValidationGroup="btnfh" /><asp:Button runat="server" ID="Button1" CssClass="btn btn-xs btn-default"
                                                Text="测试" OnClick="ImgSrs_Click1" Visible="false" />
                                                ...
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:Button runat="server" CssClass="btn2 btn-xs btn-default" ID="btnapply" CausesValidation="False"
                                                            CommandName="apply" CommandArgument='<%# Eval("nID")%>' Text="我的学员" Width="80px" />
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="False"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" Font-Size="13px" Width="8%" />
                    ...
                    <div align="center" class="bootstrap-admin-panel-content">
                        <asp:Button runat="server" ID="btnBack" class="btn btn-xs btn-default" Text="返回" OnClick="btnBack_Click" Visible="false" />
                        &nbsp;&nbsp;&nbsp;
                    </div>
                </div>
            </div>
