...
public partial class Admin_ImgConfig_ProductSelect : System.Web.UI.Page
{
    private string paixu
    {
        get
        {
            return ViewState["paixu"] == null ? "" : ViewState["paixu"].ToString();
        }
        set
        {
            ViewState["paixu"] = value;
        }
    }
    Video pc = new Video();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (string.IsNullOrEmpty(paixu))
        {
            Session["SelectProID"] = HiddenField1.Value;
        }
        else
        {
            Session["SelectProID" + paixu] = HiddenField1.Value;
        }
