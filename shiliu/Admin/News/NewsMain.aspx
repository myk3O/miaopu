<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsMain.aspx.cs" Inherits="Admin_News_NewsMain" %>
                            ...
                            <td>
                                <asp:GridView ID="gridField" runat="server" Width="100%" CssClass="gridview_m" EmptyDataText=""
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="公告标题" HeaderStyle-Font-Bold="false">
                                            <ItemTemplate>
                                                <div>
                                            ...
                                            <ItemStyle HorizontalAlign="Left" Font-Size="13px" Width="15%" />
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="公告内容" HeaderStyle-Font-Bold="false">
                                            <ItemTemplate>
                                                <div>
                                            ...
                                            <HeaderStyle Font-Bold="False"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Left" Font-Size="13px" Width="40%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="发布状态" HeaderStyle-Font-Bold="false">
                                            <ItemTemplate>
                                                <div>
                                        ...
                                        <asp:TemplateField HeaderText="管    理" HeaderStyle-Font-Bold="false">
                                            <ItemTemplate>
                                                <div>
                                                    ...
                                                    <%--<asp:Button runat="server" ID="btnUser" CssClass="btn2 btn-xs btn-default" Text="学员"
                                                        CausesValidation="False" CommandName="btnUser" CommandArgument='<%# Eval("nID")%>' />--%>
                                                </div>
                                            </ItemTemplate>
                                            <HeaderStyle Font-Bold="False"></HeaderStyle>
