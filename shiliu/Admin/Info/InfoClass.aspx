<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InfoClass.aspx.cs" Inherits="Admin_Info_InfoClass" %>
                                ...
                                <asp:GridView ID="gridField" runat="server" Width="100%" CssClass="gridview_m" EmptyDataText=""
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="所属分类" HeaderStyle-Font-Bold="false">
                                            <ItemTemplate>
                                                <div>
                                                    <asp:Label ID="lblfenleis" runat="server" Text='<%#Eval("tidname") %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                            <HeaderStyle Font-Bold="False"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Center" Font-Size="13px" Width="15%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="分类名称" HeaderStyle-Font-Bold="false">
                                            <ItemTemplate>
                                                <div>
        ...
        <table id="tab" runat="server" class="tablelistx" width="50%" style="margin: 0 auto;">
            <tr style="border-bottom: 1px solid rgba(0,0,0,0.1)">
                ...
                <td width="60%" align="left" class="auto-style3">
                    <ul class="seachformA">
                        <li>
                            <asp:DropDownList ID="Dropfenlei" runat="server">
                            </asp:DropDownList>
                        </li>
                    </ul>
                </td>
