<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeMakByOne.aspx.cs" Inherits="Admin_DaiLi_HomeMakByOne" %>
...
<body>
            ...
            <div class="bd">
                <div class="misc-info">
                    ...
                    <dl>
                        ...
                        <dt>
                            <asp:Button runat="server" ID="btnMoney" CssClass="btn1 btn-xs btn-default" Text="申请提现"
                                OnClick="btnMoney_Click" /></dt>
                    </dl>
                    <dl>
                        <dt>流动资金：</dt>
                        <dd>
    ...
    <br />
    <div class="formbody">
        <div id="divPwd" class="usual" runat="server" visible="false">
            <div id="Div2" class="tabson">
                <table id="Table1" runat="server" class="tablelistx" width="100%" style="margin: 0 auto;">
                    <tr style="border-bottom: 1px solid rgba(0,0,0,0.1)">
                        ...
                        <td align="left">
                            <asp:TextBox runat="server" ID="txtPwd" CssClass="scinputx"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*请输入"
                                ForeColor="Red" ControlToValidate="txtPwd" ValidationGroup="btnQr"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <table id="tab" runat="server" width="90%" style="margin: 0 auto;">
                    <tr>
                        <td height="25" align="center" bgcolor="#FFFFFF">
                            &nbsp;&nbsp;<asp:Button runat="server" ID="btnQr" CssClass="btn1 btn-xs btn-default"
                                ValidationGroup="btnQr" Text="确认修改" OnClick="btnQr_Click" Visible="false" />
                            &nbsp;&nbsp;<asp:Button runat="server" ID="btnUpdate" CssClass="btn1 btn-xs btn-default"
                                Text="修改密码" OnClick="btnUpdate_Click" />
