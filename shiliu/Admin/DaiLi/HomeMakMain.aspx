<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeMakMain.aspx.cs" Inherits="Admin_DaiLi_HomeMakMain" %>
        ...
        <div class="formbody">
            <div id="usual1" class="usual">
                            ...
                            <td>
                                <asp:GridView ID="gridField" runat="server" Width="100%" CssClass="gridview_m" EmptyDataText=""
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="状态" HeaderStyle-Font-Bold="false" Visible="false">
                                            <ItemTemplate>
                                                <div>
                                                    <asp:Label ID="lbloHide" runat="server" Text='<%#Eval("oHide") %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                            <HeaderStyle Font-Bold="False"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Center" Font-Size="13px" Width="5%" />
                                            ...
                                            <ItemTemplate>
                                                <div>
                                                    ...
                                                    <asp:Button runat="server" ID="btnJinyong" CssClass="btn2 btn-xs btn-default" Text="禁用"
                                                        CausesValidation="False" CommandName="jinyong" CommandArgument='<%# Eval("nID")%>' />
                                                    <asp:Button runat="server" ID="btnJiechu" CssClass="btn2 btn-xs btn-default" Text="启用"
                                                        CausesValidation="False" CommandName="qiyong" CommandArgument='<%# Eval("nID")%>' />
                                                    <asp:Button runat="server" ID="btnAddr" Width="100px" CssClass="btn2 btn-xs btn-default"
                                                        Text="生成商城地址" CausesValidation="False" CommandName="AddUrl" CommandArgument='<%# Eval("nID")%>' />
                                                    ...
                                                    <asp:Button runat="server" ID="btnDel" CssClass="btn2 btn-xs btn-default" Text="删除"
                                                        OnClientClick="return confirm('一旦删除无法恢复，确认删除？')" CausesValidation="False" CommandName="del"
                ...
                <div align="center" class="bootstrap-admin-panel-content">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <asp:Button runat="server" ID="imgdelete" class="btn btn-xs btn-default" Text="禁用"
