...
resizeTimer=setTimeout(function(){var sctop='';var bodytop=$(document).scrollTop();if($.browser.version!="6.0"&&body_width>720){if(bodytop>sctop+300){$('.nav').addClass('fixed_nav').fadeIn(500);ht.css('margin-bottom','124px')}else{$('.nav').removeClass('fixed_nav');ht.css('margin-bottom','0px')}}},200);});}
