$(document).ready(function(){
	...
	$("#sLeftBtnB").click(function(){
		if($(this).attr("class")=="sLeftBtnBSel") {
			...
			//alert(leftPositionNum);
			leftPosition=leftPositionNum+789+"px";
			//alert(leftPositionNum);
			if(leftPosition=="0px") {if($(this).attr("class") != "sLeftBtnBBan") {$(this).attr("class","sLeftBtnBBan");}}
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-3)*263;
			if((leftPositionNum+789) > bestLeftNum && $("sRightBtnB").attr("class") != "sRightBtnB") {$("#sRightBtnB").attr("class","sRightBtnB")}
...
//			 bestLeftNum=-789;
//			alert(bestLeftNum);
//			if((leftPositionNum-789)==bestLeftNum) {alert("d");$(this).attr("class","sRightBtnBBan");}
...
//	});
	...
	$("#sRightBtnB").click(function(){
		if($(this).attr("class")=="sRightBtnBSel"){
			...
			leftPosition=leftPositionNum-789+"px";
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-3)*263;
			if((leftPositionNum-789)<bestLeftNum) {$(this).attr("class","sRightBtnBBan");}
			if(leftPositionNum==0 && $("#sLeftBtnB").attr("class")=="sLeftBtnBBan") {$("#sLeftBtnB").attr("class","sLeftBtnB");}
			if($(".scrolltab .ulSmallPic").attr("rel")=="stop") {
				$(".scrolltab .ulSmallPic").attr("rel","moving");
				$(".scrolltab .ulSmallPic").stop();
