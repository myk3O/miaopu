<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthRanking.aspx.cs" Inherits="Wap_MonthRanking" %>
...
<body aria-atomic="False">
    <div class="inContent">
        <div class="tab">
            <ul class="menu">
                <li class="active"><span>每周日24点重排</span></li>
                <li><span>上月热度排行</span></li>
            </ul>
            <div class="con1">
                <dl class="MyBranch">
                    <%--<dd><a>
