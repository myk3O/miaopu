<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Navigation.aspx.cs" Inherits="Wap_Navigation" %>
...
<body aria-atomic="False" style="background: #ebebeb;">
    <div class="inContent">
        <div class="Navigation">
            <dl>
                <dd><a href="index.aspx">
                    <i class="fa fa-microphone"></i>综艺
                </a></dd>
                <dd><a href="index.aspx">
                    <i class="fa fa-video-camera"></i>娱乐
                </a></dd>
                <dd><a href="index.aspx">
                    <i class="fa fa-file-text-o"></i>资讯
                </a></dd>
                <dd><a href="index.aspx">
                    <i class="fa fa-floppy-o"></i>电影
                </a></dd>
                <dd><a href="index.aspx">
                    <i class="fa fa-star-o"></i>母婴管理
                </a></dd>
                <dd><a href="index.aspx">
                    <i class="fa fa-heart-o"></i>课程推荐
                </a></dd>
            </dl>
            <dl>
                <dd><a href="index.aspx">
