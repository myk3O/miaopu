<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyPresent.aspx.cs" Inherits="Wap_MyPresent" %>
...
<body aria-atomic="False">
    <div class="inContent">
        <dl class="MyPresent">
            <dt>兑换记录<a href="MyPresentShow.aspx?uid=<%=uid %>">申请兑换 <span>></span></a></dt>
            <%--  <dd>处理中<span>2015-09-03 00:01:34</span></dd>
            <dd>完成<span>2015-09-03 00:01:34</span></dd>--%>
            <%=liststr %>
        </dl>
    </div>
