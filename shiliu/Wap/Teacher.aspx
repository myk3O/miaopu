<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Teacher.aspx.cs" Inherits="Wap_Teacher" %>
...
<body aria-atomic="False">
    <div class="inContent">
        <div style="margin: 8px 5%; width: 90%; font-size: 14px; line-height: 26px; color: #666666;"><%=teacherMemo %></div>
    </div>
