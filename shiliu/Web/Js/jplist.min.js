...
e.options.prevArrow;g=e.$control.attr("data-next")||e.options.nextArrow;f=e.$control.attr("data-first")||e.options.firstArrow;l=e.$control.attr("data-last")||e.options.lastArrow;e.$control.html('<div class="jplist-pagingnext" data-type="pagingnext"></div><div class="jplist-pagingmid" data-type="pagingmid"></div><div class="jplist-pagingprev" data-type="pagingprev"></div>');e.$pagingprev=e.$control.find('[data-type="pagingprev"]');e.$pagingmid=e.$control.find('[data-type="pagingmid"]');e.$pagingnext=
