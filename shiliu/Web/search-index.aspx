<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search-index.aspx.cs" Inherits="Web_search_index" %>
    ...
    <div class="main innerbox">
        <div class="nav">
            <div class="Navigation">
                您当前的位置： <span><a href="index.aspx" alt="" title="">首页</a></span> <span class="now">>
                    商品搜索</span>
            </div>
        </div>
